...
To limit Twitter requests a savepoint file marks Tweets 
found before. It's Twitter API v1.1 ready.

This code is from https://github.com/basti2342/retweet-bot
"""
